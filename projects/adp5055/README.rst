...
* `ADP5055DC1-EVALZ <https://www.analog.com/en/resources/evaluation-hardware-and-software/evaluation-boards-kits/eval-adp5055.html#eb-documentation>`_

Overview
--------

The evaluation board allows the ADP5055 to be exercised without the need for
...
and 12V voltages for the ADP5055DC1-EVALZ daughter board to simulate a parallel
circuit to the ADP5055 as well as a +5V Power Supply for the PMBUS/I2C
interface.
...
This is a simple example that initializes the ADP5055, unlock its CHIP, EEPROM
...
This project is actually a IIOD demo for ADP5055DC1-EVALZ evaluation board.
...
* `ADP5055DC1-EVALZ daughter board <https://www.analog.com/en/resources/evaluation-hardware-and-software/evaluation-boards-kits/eval-adp5055.html#eb-overview>`_
...
+-----------------------------+------------+----------------------------------------------+-----------------------------+
| ADP5055DC1-EVALZ Pin Number |  Mnemonic  | Function					  | AD-APARD32690-SL Pin Number |
+-----------------------------+------------+----------------------------------------------+-----------------------------+
| 2			      | VS-	   | Ground					  | GND			        |
+-----------------------------+------------+----------------------------------------------+-----------------------------+
